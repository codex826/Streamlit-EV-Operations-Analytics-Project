...
def generate_voltride_data(n_samples=5000):
    ...
    # Logic to simulate cancellations based on the case study constraints
    # Cancellations cluster around peak hours, rain, low battery, and high charging waits
    def determine_outcome(row):
        ...
        # Rain spikes demand but lowers availability
        if row['Weather'] == 'Rain':
            cancel_prob += 0.15
            
        # High charging congestion in the zone
...
page = st.sidebar.radio("Navigation", ["1. Operational Dashboard", "2. Cancellation Predictor (ML)", "3. Fleet Redeployment"])
...
# --- 5. PAGE 3: FLEET REDEPLOYMENT ---
    ...
    **Analytical Logic**: 
    ...
    # Add quadrants to help management visually decide
